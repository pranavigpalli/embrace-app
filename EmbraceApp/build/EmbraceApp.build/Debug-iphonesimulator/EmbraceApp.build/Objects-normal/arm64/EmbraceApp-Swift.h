...
#ifndef EMBRACEAPP_SWIFT_H
#define EMBRACEAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EmbraceApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10EmbraceApp16ArmBleController")
@interface ArmBleController : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class CBPeripheral;
@class CBService;
@interface ArmBleController (SWIFT_EXTENSION(EmbraceApp)) <CBPeripheralDelegate>
...
@class NSString;
@class NSNumber;
@interface ArmBleController (SWIFT_EXTENSION(EmbraceApp)) <CBCentralManagerDelegate>
